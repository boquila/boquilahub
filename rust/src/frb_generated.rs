...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1952746378;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        5 => wire__crate__api__inference__detect_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__utils__get_cuda_version_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__inference__init_app_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__preprocessing__prepare_input_impl(port, ptr, rust_vec_len, data_len),
        9 => {
            wire__crate__api__postprocessing__process_output_impl(port, ptr, rust_vec_len, data_len)
        }
        10 => wire__crate__api__inference__set_model_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__abstractions__xyw_hn_area_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__abstractions__xyw_hn_get_class_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        15 => wire__crate__api__abstractions__xyw_hn_iou_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__abstractions__xyw_hn_new_impl(port, ptr, rust_vec_len, data_len),
        17 => {
            wire__crate__api__abstractions__xyw_hn_toxyxyn_impl(port, ptr, rust_vec_len, data_len)
        }
        18 => wire__crate__api__abstractions__xywh_area_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__abstractions__xywh_get_class_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__abstractions__xywh_get_prob_impl(port, ptr, rust_vec_len, data_len),
        21 => {
            wire__crate__api__abstractions__xywh_intersect_impl(port, ptr, rust_vec_len, data_len)
        }
        22 => wire__crate__api__abstractions__xywh_iou_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__abstractions__xywh_new_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__abstractions__xywh_toxyxyn_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__abstractions__xyx_yn_area_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__abstractions__xyx_yn_get_class_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        29 => wire__crate__api__abstractions__xyx_yn_iou_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__abstractions__xyx_yn_new_impl(port, ptr, rust_vec_len, data_len),
        31 => {
            wire__crate__api__abstractions__xyx_yn_toxywhn_impl(port, ptr, rust_vec_len, data_len)
        }
        32 => wire__crate__api__abstractions__xyxy_area_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__abstractions__xyxy_get_class_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        34 => wire__crate__api__abstractions__xyxy_get_prob_impl(port, ptr, rust_vec_len, data_len),
        35 => {
            wire__crate__api__abstractions__xyxy_intersect_impl(port, ptr, rust_vec_len, data_len)
        }
        36 => wire__crate__api__abstractions__xyxy_iou_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__abstractions__xyxy_new_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__abstractions__xyxy_toxywhn_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
